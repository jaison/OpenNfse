...
final class ReportsController
{
    ...
    public function showRelatorios(): void
    {
        ...
        $tabMeta = [
            ...
            'auditoria_api' => [
                ...
                'badge_bg' => '#eaf7f1',
                'badge_color' => '#176b46',
                'summary' => 'Sincroniza a distribuicao da API por NSU e compara os documentos recebidos com o historico fiscal local.',
            ],
            'logs' => [
                'label' => 'Logs',
                'badge' => 'Técnico',
    ...
    public function showRelatorioAuditoriaApi(bool $embedded = false): void
    {
        ...
        if ($syncError !== null) {
            ...
            echo '<div class="alert alert-success" style="margin-bottom:14px;">Sincronizacao concluida. Foram processados <strong>' . (int) ($syncResult['processed_count'] ?? 0) . '</strong> documentos em <strong>' . (int) ($syncResult['batch_count'] ?? 0) . '</strong> lote(s).</div>';
        }
