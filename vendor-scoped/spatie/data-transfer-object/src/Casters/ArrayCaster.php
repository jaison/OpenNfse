...
{
    public function __construct(private array $types, private string $itemType)
    {
    }
    ...
    private function castItem(mixed $data)
    {
        ...
        throw new LogicException("Caster [ArrayCaster] each item must be an array or an instance of the specified item type [{$this->itemType}].");
    }
}
