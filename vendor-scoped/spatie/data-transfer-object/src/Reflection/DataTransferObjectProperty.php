...
class DataTransferObjectProperty
{
    ...
    {
        $attributes = $this->reflectionProperty->getAttributes(Validator::class, ReflectionAttribute::IS_INSTANCEOF);
    ...
    private function resolveCaster(): ?Caster
    {
        ...
        return new $attribute->casterClass(array_map(fn($type) => $this->resolveTypeName($type), $this->extractTypes()), ...$attribute->args);
    }
