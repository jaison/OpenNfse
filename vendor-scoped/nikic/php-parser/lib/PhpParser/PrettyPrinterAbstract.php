...
use OpenNfseVendor\PhpParser\Internal\DiffElem;
use OpenNfseVendor\PhpParser\Internal\Differ;
use OpenNfseVendor\PhpParser\Internal\PrintableNewAnonClassNode;
use OpenNfseVendor\PhpParser\Internal\TokenStream;
use OpenNfseVendor\PhpParser\Node\AttributeGroup;
...
use OpenNfseVendor\PhpParser\Node\IntersectionType;
...
use OpenNfseVendor\PhpParser\Node\Scalar;
use OpenNfseVendor\PhpParser\Node\Stmt;
use OpenNfseVendor\PhpParser\Node\UnionType;
