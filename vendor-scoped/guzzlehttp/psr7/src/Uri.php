...
class Uri implements UriInterface, \JsonSerializable
{
    ...
    public function withPort($port): UriInterface
    {
        if ($port !== null && !\is_int($port)) {
            \OpenNfseVendor\trigger_deprecation('guzzlehttp/psr7', '2.11', 'Passing %s to UriInterface::withPort() is deprecated; guzzlehttp/psr7 3.0 requires int|null.', \get_debug_type($port));
        }
    ...
    private function filterScheme($scheme): string
    {
        ...
        if ($scheme !== '' && !preg_match('/^[a-z][a-z0-9.+-]*$/D', $scheme)) {
            \OpenNfseVendor\trigger_deprecation('guzzlehttp/psr7', '2.11', 'Passing "%s" as a URI scheme is deprecated; guzzlehttp/psr7 3.0 requires URI schemes to match RFC 3986 syntax and begin with a letter.', $scheme);
        }
        return $scheme;
    }
    /**
    ...
    private function filterUserInfoComponent($component): string
    {
        ...
        return preg_replace_callback('/(?:[^%' . \GuzzleHttp\Psr7\Rfc3986::CHAR_UNRESERVED . \GuzzleHttp\Psr7\Rfc3986::CHAR_SUB_DELIMS . ']+|%(?![A-Fa-f0-9]{2}))/', [$this, 'rawurlencodeMatchZero'], $component);
    }
    /**
     * @param mixed $host
     *
    ...
    private function filterPath($path): string
    {
        ...
        return preg_replace_callback('/(?:[^' . \GuzzleHttp\Psr7\Rfc3986::CHAR_UNRESERVED . \GuzzleHttp\Psr7\Rfc3986::CHAR_SUB_DELIMS . '%:@\/]++|%(?![A-Fa-f0-9]{2}))/', [$this, 'rawurlencodeMatchZero'], $path);
    }
    /**
    ...
    private function filterQueryAndFragment($str): string
    {
        ...
        return preg_replace_callback('/(?:[^' . \GuzzleHttp\Psr7\Rfc3986::CHAR_UNRESERVED . \GuzzleHttp\Psr7\Rfc3986::CHAR_SUB_DELIMS . '%:@\/\?]++|%(?![A-Fa-f0-9]{2}))/', [$this, 'rawurlencodeMatchZero'], $str);
    }
