 ...
 * @link https://php.net/manual/en/class.memcached.php
 */
\class_alias('OpenNfseVendor\Memcached', 'Memcached', \false);
/**
 * @link https://php.net/manual/en/class.memcachedexception.php
 */
class MemcachedException extends \RuntimeException
{
    #[\OpenNfseVendor\JetBrains\PhpStorm\Pure]
 ...
 * @link https://php.net/manual/en/class.memcachedexception.php
 */
\class_alias('OpenNfseVendor\MemcachedException', 'MemcachedException', \false);
