...
// Start of Zend Extensions
\class_alias('OpenNfseVendor\ZendAPI_Queue', 'ZendAPI_Queue', \false);
/**
 ...
 * For simplicity, a job can be added directly to a queue and without creating an instant of a Queue object
 */
\class_alias('OpenNfseVendor\ZendAPI_Job', 'ZendAPI_Job', \false);
/**
...
\class_alias('OpenNfseVendor\java', 'java', \false);
class JavaException
{
    /**
...
\class_alias('OpenNfseVendor\JavaException', 'JavaException', \false);
