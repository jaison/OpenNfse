 ...
 * @link https://www.php.net/manual/en/class.zookeeper.php
 */
\class_alias('OpenNfseVendor\Zookeeper', 'Zookeeper', \false);
class ZookeeperException extends \Exception
{
}
\class_alias('OpenNfseVendor\ZookeeperException', 'ZookeeperException', \false);
class ZookeeperOperationTimeoutException extends \ZookeeperException
{
}
\class_alias('OpenNfseVendor\ZookeeperOperationTimeoutException', 'ZookeeperOperationTimeoutException', \false);
class ZookeeperConnectionException extends \ZookeeperException
{
}
\class_alias('OpenNfseVendor\ZookeeperConnectionException', 'ZookeeperConnectionException', \false);
class ZookeeperMarshallingException extends \ZookeeperException
{
}
\class_alias('OpenNfseVendor\ZookeeperMarshallingException', 'ZookeeperMarshallingException', \false);
class ZookeeperAuthenticationException extends \ZookeeperException
{
}
\class_alias('OpenNfseVendor\ZookeeperAuthenticationException', 'ZookeeperAuthenticationException', \false);
class ZookeeperSessionException extends \ZookeeperException
{
}
\class_alias('OpenNfseVendor\ZookeeperSessionException', 'ZookeeperSessionException', \false);
class ZookeeperNoNodeException extends \ZookeeperException
{
}
\class_alias('OpenNfseVendor\ZookeeperNoNodeException', 'ZookeeperNoNodeException', \false);
