 ...
 * @see https://php.net/manual/en/class.event.php
 */
\class_alias('OpenNfseVendor\Event', 'Event', \false);
//  The EventBase class
/**
 * EventBase.
 ...
 * @see https://php.net/manual/en/class.eventbase.php
 */
\class_alias('OpenNfseVendor\EventBase', 'EventBase', \false);
 ...
 * @see https://php.net/manual/en/class.eventbuffer.php
 */
\class_alias('OpenNfseVendor\EventBuffer', 'EventBuffer', \false);
 ...
 * @see https://php.net/manual/en/class.eventbufferevent.php
 */
\class_alias('OpenNfseVendor\EventBufferEvent', 'EventBufferEvent', \false);
 ...
 * @see https://secure.php.net/manual/en/class.eventconfig.php
 */
\class_alias('OpenNfseVendor\EventConfig', 'EventConfig', \false);
 ...
 * @see https://secure.php.net/manual/en/class.eventdnsbase.php
 */
\class_alias('OpenNfseVendor\EventDnsBase', 'EventDnsBase', \false);
// The EventHttp class
/**
 * EventHttp.
 ...
 * @see https://secure.php.net/manual/en/class.eventhttp.php
 */
\class_alias('OpenNfseVendor\EventHttp', 'EventHttp', \false);
 ...
 * @see https://secure.php.net/manual/en/class.eventhttpconnection.php
 */
\class_alias('OpenNfseVendor\EventHttpConnection', 'EventHttpConnection', \false);
...
// The EventHttpRequest class
\class_alias('OpenNfseVendor\EventHttpRequest', 'EventHttpRequest', \false);
 ...
 * @see https://secure.php.net/manual/en/class.eventlistener.php
 */
\class_alias('OpenNfseVendor\EventListener', 'EventListener', \false);
 ...
 * @see https://secure.php.net/manual/en/class.eventsslcontext.php
 */
\class_alias('OpenNfseVendor\EventSslContext', 'EventSslContext', \false);
// The EventUtil class
/**
 * EventUtil.
 ...
 * @see https://secure.php.net/manual/en/class.eventutil.php
 */
\class_alias('OpenNfseVendor\EventUtil', 'EventUtil', \false);
