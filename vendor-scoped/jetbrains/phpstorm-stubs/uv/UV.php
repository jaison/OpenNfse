...
\class_alias('OpenNfseVendor\UV', 'UV', \false);
abstract class UVStream extends \UV
{
}
\class_alias('OpenNfseVendor\UVStream', 'UVStream', \false);
class UVTcp extends \UVStream
{
}
\class_alias('OpenNfseVendor\UVTcp', 'UVTcp', \false);
class UVUdp extends \UV
{
}
\class_alias('OpenNfseVendor\UVUdp', 'UVUdp', \false);
class UVPipe extends \UVStream
{
}
\class_alias('OpenNfseVendor\UVPipe', 'UVPipe', \false);
class UVIdle extends \UV
{
}
\class_alias('OpenNfseVendor\UVIdle', 'UVIdle', \false);
class UVTimer extends \UV
{
}
\class_alias('OpenNfseVendor\UVTimer', 'UVTimer', \false);
class UVAsync extends \UV
{
}
\class_alias('OpenNfseVendor\UVAsync', 'UVAsync', \false);
class UVAddrinfo extends \UV
{
}
\class_alias('OpenNfseVendor\UVAddrinfo', 'UVAddrinfo', \false);
class UVProcess extends \UV
{
}
\class_alias('OpenNfseVendor\UVProcess', 'UVProcess', \false);
class UVPrepare extends \UV
{
}
\class_alias('OpenNfseVendor\UVPrepare', 'UVPrepare', \false);
class UVCheck extends \UV
{
}
\class_alias('OpenNfseVendor\UVCheck', 'UVCheck', \false);
class UVWork extends \UV
{
}
\class_alias('OpenNfseVendor\UVWork', 'UVWork', \false);
class UVFs extends \UV
{
}
\class_alias('OpenNfseVendor\UVFs', 'UVFs', \false);
class UVFsEvent extends \UV
{
}
\class_alias('OpenNfseVendor\UVFsEvent', 'UVFsEvent', \false);
class UVTty extends \UVStream
{
}
\class_alias('OpenNfseVendor\UVTty', 'UVTty', \false);
class UVFsPoll extends \UV
{
}
\class_alias('OpenNfseVendor\UVFsPoll', 'UVFsPoll', \false);
class UVPoll extends \UV
{
}
\class_alias('OpenNfseVendor\UVPoll', 'UVPoll', \false);
class UVSignal extends \UV
{
}
\class_alias('OpenNfseVendor\UVSignal', 'UVSignal', \false);
class UVLoop
{
}
\class_alias('OpenNfseVendor\UVLoop', 'UVLoop', \false);
abstract class UVSockAddr
{
}
\class_alias('OpenNfseVendor\UVSockAddr', 'UVSockAddr', \false);
class UVSockAddrIPv4 extends \UVSockAddr
{
}
\class_alias('OpenNfseVendor\UVSockAddrIPv4', 'UVSockAddrIPv4', \false);
class UVSockAddrIPv6 extends \UVSockAddr
{
}
\class_alias('OpenNfseVendor\UVSockAddrIPv6', 'UVSockAddrIPv6', \false);
class UVLock
{
}
\class_alias('OpenNfseVendor\UVLock', 'UVLock', \false);
class UVStdio
{
}
\class_alias('OpenNfseVendor\UVStdio', 'UVStdio', \false);
