 ...
 * @template-implements Iterator<TKey, TYield>
 */
\class_alias('OpenNfseVendor\Generator', 'Generator', \false);
class ClosedGeneratorException extends \Exception
{
}
\class_alias('OpenNfseVendor\ClosedGeneratorException', 'ClosedGeneratorException', \false);
namespace OpenNfseVendor\___PHPSTORM_HELPERS;
