 ...
 * created using:
 */
\class_alias('OpenNfseVendor\classObj', 'classObj', \false);
/**
 ...
 * Instance of clusterObj is always embedded inside the `layerObj`_.
 */
\class_alias('OpenNfseVendor\clusterObj', 'clusterObj', \false);
/**
 ...
 * Instances of colorObj are always embedded inside other classes.
 */
\class_alias('OpenNfseVendor\colorObj', 'colorObj', \false);
...
\class_alias('OpenNfseVendor\errorObj', 'errorObj', \false);
/**
 ...
 * $oLayer->grid->set("labelformat", "DDMMSS");
 */
\class_alias('OpenNfseVendor\gridObj', 'gridObj', \false);
/**
 ...
 * echo "Key: ".$key." value: ".$hashTable->get($key)."<br/>";
 */
\class_alias('OpenNfseVendor\hashTableObj', 'hashTableObj', \false);
/**
 ...
 * Instances of imageObj are always created by the `mapObj`_ class methods.
 */
\class_alias('OpenNfseVendor\imageObj', 'imageObj', \false);
...
\class_alias('OpenNfseVendor\labelcacheMemberObj', 'labelcacheMemberObj', \false);
...
\class_alias('OpenNfseVendor\labelcacheObj', 'labelcacheObj', \false);
/**
 ...
 * labelObj are always embedded inside other classes.
 */
\class_alias('OpenNfseVendor\labelObj', 'labelObj', \false);
/**
 ...
 * layer created.
 */
\class_alias('OpenNfseVendor\layerObj', 'layerObj', \false);
/**
 ...
 * Instances of legendObj are always are always embedded inside the `mapObj`_.
 */
\class_alias('OpenNfseVendor\legendObj', 'legendObj', \false);
final class lineObj
{
    /**
     * read-only
...
\class_alias('OpenNfseVendor\lineObj', 'lineObj', \false);
final class mapObj
{
    /**
     * @var float
...
\class_alias('OpenNfseVendor\mapObj', 'mapObj', \false);
/**
 ...
 * No constructor available (coming soon, see ticket 979)
 */
\class_alias('OpenNfseVendor\outputformatObj', 'outputformatObj', \false);
...
\class_alias('OpenNfseVendor\OwsrequestObj', 'OwsrequestObj', \false);
...
\class_alias('OpenNfseVendor\pointObj', 'pointObj', \false);
...
\class_alias('OpenNfseVendor\projectionObj', 'projectionObj', \false);
/**
 ...
 * `mapObj`_.
 */
\class_alias('OpenNfseVendor\querymapObj', 'querymapObj', \false);
/**
 ...
 * also be created with:
 */
\class_alias('OpenNfseVendor\rectObj', 'rectObj', \false);
/**
 ...
 * Instances of referenceMapObj are always embedded inside the `mapObj`_.
 */
\class_alias('OpenNfseVendor\referenceMapObj', 'referenceMapObj', \false);
...
\class_alias('OpenNfseVendor\resultObj', 'resultObj', \false);
/**
 ...
 * Instances of scalebarObj are always embedded inside the `mapObj`_.
 */
\class_alias('OpenNfseVendor\scalebarObj', 'scalebarObj', \false);
...
\class_alias('OpenNfseVendor\shapefileObj', 'shapefileObj', \false);
...
\class_alias('OpenNfseVendor\shapeObj', 'shapeObj', \false);
/**
 ...
 * Instances of styleObj are always embedded inside a `classObj`_ or `labelObj`_.
 */
\class_alias('OpenNfseVendor\styleObj', 'styleObj', \false);
...
\class_alias('OpenNfseVendor\symbolObj', 'symbolObj', \false);
/**
 ...
 * Instances of webObj are always are always embedded inside the `mapObj`_.
 */
\class_alias('OpenNfseVendor\webObj', 'webObj', \false);
