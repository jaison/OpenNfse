...
// Start of svn v.1.0.1
\class_alias('OpenNfseVendor\Svn', 'Svn', \false);
class SvnWc
{
    public const NONE = 1;
...
\class_alias('OpenNfseVendor\SvnWc', 'SvnWc', \false);
class SvnWcSchedule
{
...
\class_alias('OpenNfseVendor\SvnWcSchedule', 'SvnWcSchedule', \false);
class SvnNode
{
    public const NONE = 0;
    public const FILE = 1;
...
\class_alias('OpenNfseVendor\SvnNode', 'SvnNode', \false);
/**
 * (PECL svn &gt;= 0.1.0)<br/>
