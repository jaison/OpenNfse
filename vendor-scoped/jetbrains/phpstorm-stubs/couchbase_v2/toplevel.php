 ...
 */
\class_alias("Couchbase\\Cluster", "OpenNfseVendor\\CouchbaseCluster");
\class_alias("Couchbase\\Bucket", "OpenNfseVendor\\CouchbaseBucket");
\class_alias("Couchbase\\MutationToken", "OpenNfseVendor\\CouchbaseMutationToken");
\class_alias("Couchbase\\MutationState", "OpenNfseVendor\\CouchbaseMutationState");
\class_alias("Couchbase\\BucketManager", "OpenNfseVendor\\CouchbaseBucketManager");
\class_alias("OpenNfseVendor\\Couchbase\\ClusterManager", "OpenNfseVendor\\CouchbaseClusterManager");
\class_alias("OpenNfseVendor\\Couchbase\\LookupInBuilder", "OpenNfseVendor\\CouchbaseLookupInBuilder");
\class_alias("OpenNfseVendor\\Couchbase\\MutateInBuilder", "OpenNfseVendor\\CouchbaseMutateInBuilder");
\class_alias("OpenNfseVendor\\Couchbase\\N1qlQuery", "OpenNfseVendor\\CouchbaseN1qlQuery");
\class_alias("Couchbase\\SearchQuery", "OpenNfseVendor\\CouchbaseSearchQuery");
\class_alias("OpenNfseVendor\\Couchbase\\SearchQueryPart", "OpenNfseVendor\\CouchbaseAbstractSearchQuery");
\class_alias("Couchbase\\QueryStringSearchQuery", "OpenNfseVendor\\CouchbaseStringSearchQuery");
\class_alias("Couchbase\\MatchSearchQuery", "OpenNfseVendor\\CouchbaseMatchSearchQuery");
\class_alias("Couchbase\\MatchPhraseSearchQuery", "OpenNfseVendor\\CouchbaseMatchPhraseSearchQuery");
\class_alias("Couchbase\\PrefixSearchQuery", "OpenNfseVendor\\CouchbasePrefixSearchQuery");
\class_alias("Couchbase\\RegexpSearchQuery", "OpenNfseVendor\\CouchbaseRegexpSearchQuery");
\class_alias("Couchbase\\NumericRangeSearchQuery", "OpenNfseVendor\\CouchbaseNumericRangeSearchQuery");
\class_alias("Couchbase\\DisjunctionSearchQuery", "OpenNfseVendor\\CouchbaseDisjunctionSearchQuery");
\class_alias("Couchbase\\DateRangeSearchQuery", "OpenNfseVendor\\CouchbaseDateRangeSearchQuery");
\class_alias("Couchbase\\ConjunctionSearchQuery", "OpenNfseVendor\\CouchbaseConjunctionSearchQuery");
\class_alias("Couchbase\\BooleanSearchQuery", "OpenNfseVendor\\CouchbaseBooleanSearchQuery");
\class_alias("Couchbase\\WildcardSearchQuery", "OpenNfseVendor\\CouchbaseWildcardSearchQuery");
\class_alias("Couchbase\\DocIdSearchQuery", "OpenNfseVendor\\CouchbaseDocIdSearchQuery");
\class_alias("Couchbase\\BooleanFieldSearchQuery", "OpenNfseVendor\\CouchbaseBooleanFieldSearchQuery");
\class_alias("Couchbase\\TermSearchQuery", "OpenNfseVendor\\CouchbaseTermSearchQuery");
\class_alias("Couchbase\\PhraseSearchQuery", "OpenNfseVendor\\CouchbasePhraseSearchQuery");
\class_alias("Couchbase\\MatchAllSearchQuery", "OpenNfseVendor\\CouchbaseMatchAllSearchQuery");
\class_alias("Couchbase\\MatchNoneSearchQuery", "OpenNfseVendor\\CouchbaseMatchNoneSearchQuery");
\class_alias("Couchbase\\DateRangeSearchFacet", "OpenNfseVendor\\CouchbaseDateRangeSearchFacet");
\class_alias("Couchbase\\NumericRangeSearchFacet", "OpenNfseVendor\\CouchbaseNumericRangeSearchFacet");
\class_alias("Couchbase\\TermSearchFacet", "OpenNfseVendor\\CouchbaseTermSearchFacet");
\class_alias("Couchbase\\SearchFacet", "OpenNfseVendor\\CouchbaseSearchFacet");
\class_alias("OpenNfseVendor\\Couchbase\\ViewQuery", "OpenNfseVendor\\CouchbaseViewQuery");
\class_alias("OpenNfseVendor\\Couchbase\\DocumentFragment", "OpenNfseVendor\\CouchbaseDocumentFragment");
\class_alias("OpenNfseVendor\\Couchbase\\Document", "OpenNfseVendor\\CouchbaseMetaDoc");
\class_alias("OpenNfseVendor\\Couchbase\\Exception", "OpenNfseVendor\\CouchbaseException");
\class_alias("OpenNfseVendor\\Couchbase\\ClassicAuthenticator", "OpenNfseVendor\\CouchbaseAuthenticator");
