 ...
 * @since luasandbox >= 1.0.0
 */
\class_alias('OpenNfseVendor\LuaSandbox', 'LuaSandbox', \false);
/**
 ...
 * @since luasandbox >= 1.0.0
 */
\class_alias('OpenNfseVendor\LuaSandboxFunction', 'LuaSandboxFunction', \false);
/**
 ...
 * @since luasandbox >= 1.0.0
 */
\class_alias('OpenNfseVendor\LuaSandboxError', 'LuaSandboxError', \false);
/**
 ...
 * @since luasandbox >= 1.0.0
 */
\class_alias('OpenNfseVendor\LuaSandboxRuntimeError', 'LuaSandboxRuntimeError', \false);
/**
 ...
 * @since luasandbox >= 1.0.0
 */
\class_alias('OpenNfseVendor\LuaSandboxFatalError', 'LuaSandboxFatalError', \false);
/**
 ...
 * @since luasandbox >= 1.0.0
 */
\class_alias('OpenNfseVendor\LuaSandboxErrorError', 'LuaSandboxErrorError', \false);
/**
 ...
 * @see LuaSandbox::setMemoryLimit()
 */
\class_alias('OpenNfseVendor\LuaSandboxMemoryError', 'LuaSandboxMemoryError', \false);
/**
 ...
 * @since luasandbox >= 1.0.0
 */
\class_alias('OpenNfseVendor\LuaSandboxSyntaxError', 'LuaSandboxSyntaxError', \false);
/**
 ...
 * @see LuaSandbox::setCPULimit()
 */
\class_alias('OpenNfseVendor\LuaSandboxTimeoutError', 'LuaSandboxTimeoutError', \false);
