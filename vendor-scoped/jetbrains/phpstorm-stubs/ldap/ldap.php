...
use OpenNfseVendor\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware as PhpVersionAware;
use OpenNfseVendor\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable as Available;
use LDAP\Result;
/**
...
function ldap_exop_passwd(
    #[PhpVersionAware(['8.1' => 'OpenNfseVendor\LDAP\Connection'], default: 'resource')]
    $ldap,
...
function ldap_parse_exop(
    #[PhpVersionAware(['8.1' => 'OpenNfseVendor\LDAP\Connection'], default: 'resource')]
    $ldap,
    #[PhpVersionAware(['8.1' => 'OpenNfseVendor\LDAP\Result'], default: 'resource')]
    $result,
...
function ldap_next_entry(
    #[PhpVersionAware(['8.1' => 'OpenNfseVendor\LDAP\Connection'], default: 'resource')]
    $ldap,
    #[PhpVersionAware(['8.1' => 'OpenNfseVendor\LDAP\ResultEntry'], default: 'resource')]
    $entry
)
{
}
...
function ldap_get_option(
    #[PhpVersionAware(['8.1' => 'OpenNfseVendor\LDAP\Connection', '8.5' => '\LDAP\Connection|null'], default: 'resource')]
    $ldap,
    int $option,
