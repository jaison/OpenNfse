 ...
 */
use OpenNfseVendor\Symfony\Polyfill\Intl\Normalizer as p;
if (!\function_exists('normalizer_is_normalized') && !\function_exists('OpenNfseVendor\normalizer_is_normalized')) {
...
if (!\function_exists('normalizer_normalize') && !\function_exists('OpenNfseVendor\normalizer_normalize')) {
...
if (!\function_exists('normalizer_get_raw_decomposition') && !\function_exists('OpenNfseVendor\normalizer_get_raw_decomposition')) {
