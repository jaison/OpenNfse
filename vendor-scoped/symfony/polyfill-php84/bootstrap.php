 ...
 */
use OpenNfseVendor\Symfony\Polyfill\Php84 as p;
...
if (!\function_exists('array_find') && !\function_exists('OpenNfseVendor\array_find')) {
    function array_find(array $array, callable $callback)
    {
        return p\Php84::array_find($array, $callback);
    }
}
if (!\function_exists('array_find_key') && !\function_exists('OpenNfseVendor\array_find_key')) {
    function array_find_key(array $array, callable $callback)
    {
        return p\Php84::array_find_key($array, $callback);
    }
}
if (!\function_exists('array_any') && !\function_exists('OpenNfseVendor\array_any')) {
    function array_any(array $array, callable $callback): bool
    {
        return p\Php84::array_any($array, $callback);
    }
}
if (!\function_exists('array_all') && !\function_exists('OpenNfseVendor\array_all')) {
    function array_all(array $array, callable $callback): bool
    {
        return p\Php84::array_all($array, $callback);
    }
}
if (!\function_exists('fpow') && !\function_exists('OpenNfseVendor\fpow')) {
...
if (\extension_loaded('bcmath')) {
    if (!\function_exists('bcceil') && !\function_exists('OpenNfseVendor\bcceil')) {
        function bcceil(string $num): string
        {
            return p\Php84::bcceil($num);
        }
    }
    if (!\function_exists('bcdivmod') && !\function_exists('OpenNfseVendor\bcdivmod')) {
        function bcdivmod(string $num1, string $num2, ?int $scale = null): ?array
        {
            return p\Php84::bcdivmod($num1, $num2, $scale);
        }
    }
    if (!\function_exists('bcfloor') && !\function_exists('OpenNfseVendor\bcfloor')) {
        function bcfloor(string $num): string
        {
            return p\Php84::bcfloor($num);
        }
    }
    if (!\function_exists('bcround') && !\function_exists('OpenNfseVendor\bcround')) {
...
if (\extension_loaded('intl') && (!\function_exists('grapheme_str_split') && !\function_exists('OpenNfseVendor\grapheme_str_split'))) {
