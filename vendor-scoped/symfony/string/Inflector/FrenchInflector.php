 ...
 */
namespace OpenNfseVendor\Symfony\Component\String\Inflector;
...
final class FrenchInflector implements InflectorInterface
{
    ...
    private const PLURALIZE_REGEXP = [
        ...
        // French titles
        ['/^(mon|ma)(sieur|dame|demoiselle|seigneur)$/', 'OpenNfseVendor\mes\2s'],
        ['/^(Mon|Ma)(sieur|dame|demoiselle|seigneur)$/', 'OpenNfseVendor\Mes\2s'],
    ];
    /**
    ...
    private const SINGULARIZE_REGEXP = [
        ...
        // French titles
        ['/^mes(dame|demoiselle)s$/', 'OpenNfseVendor\ma\1'],
        ['/^Mes(dame|demoiselle)s$/', 'OpenNfseVendor\Ma\1'],
        ['/^mes(sieur|seigneur)s$/', 'OpenNfseVendor\mon\1'],
        ['/^Mes(sieur|seigneur)s$/', 'OpenNfseVendor\Mon\1'],
        // Default rule
        ['/s$/i', ''],
    ];
