...
try {
    ...
    $chaveNfse = '35503080000000000000000000000000000000000000';
    // Chave da nota a ser cancelada
    $cnpjAutor = '03279735000194';
    // CNPJ do Prestador
    $eventoData = new PedRegEventoData(['versao' => '1.01', 'infPedReg' => [
        'tpAmb' => 2,
