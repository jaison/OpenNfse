...
class EnumCaster implements Caster
{
    ...
    public function __construct(array $types, private string $enumType)
    {
    }
    public function cast(mixed $value): mixed
    {
        ...
        if ($reflection->isBacked() && $backingType instanceof \ReflectionNamedType && $backingType->getName() === 'int' && is_string($value) && is_numeric($value)) {
            $value = (int) $value;
        }
