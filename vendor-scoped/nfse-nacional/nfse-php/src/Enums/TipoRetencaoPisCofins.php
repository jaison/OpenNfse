...
enum TipoRetencaoPisCofins : int
{
    ...
    {
        return match ($this) {
            self::PisCofinsRetido, self::Retidos, self::PisCofinsRetidosCsllNaoRetido, self::PisRetidoCofinsCsllNaoRetido, self::CofinsNaoRetidoPisCsllRetidos => \true,
            default => \false,
        };
    }
    /**
    ...
    {
        return match ($this) {
            self::PisCofinsRetido, self::Retidos, self::PisCofinsRetidosCsllNaoRetido, self::CofinsRetidoPisCsllNaoRetido, self::PisNaoRetidoCofinsCsllRetidos => \true,
            default => \false,
        };
    }
    /**
    ...
    {
        return match ($this) {
            self::Retidos, self::PisNaoRetidoCofinsCsllRetidos, self::PisCofinsNaoRetidosCsllRetido, self::CofinsNaoRetidoPisCsllRetidos => \true,
            default => \false,
        };
    }
}
