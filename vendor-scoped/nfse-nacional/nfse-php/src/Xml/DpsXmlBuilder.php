...
class DpsXmlBuilder
{
    ...
    private function buildServico(DOMElement $parent, ServicoData $data): void
    {
        ...
        if ($data->comercioExterior) {
            ...
            $this->appendElement($comExt, 'vServMoeda', $data->comercioExterior->valorServicoMoeda !== null ? number_format($data->comercioExterior->valorServicoMoeda, 2, '.', '') : null);
    ...
    private function buildValores(DOMElement $parent, ValoresData $data, ?PrestadorData $prestador = null): void
    {
        ...
        if ($data->tributacao) {
            ...
            $this->appendElement($tribMun, 'pAliq', $data->tributacao->aliquota !== null ? number_format($data->tributacao->aliquota, 2, '.', '') : null);
            ...
            if ($hasPiscofins || $hasRetencoesFed) {
                ...
                $this->appendElement($tribFed, 'vRetContPrev', null);
