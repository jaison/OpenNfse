...
class InfDpsData extends Dto
{
     ...
     */
    #[MapFrom('subst')]
    public ?\Nfse\Dto\Nfse\SubstituicaoData $substituicao = null;
    /**
     * Dados do prestador do serviço.
     */
    #[MapFrom('prest')]
    public ?\Nfse\Dto\Nfse\PrestadorData $prestador = null;
    /**
     * Dados do tomador do serviço.
     */
    #[MapFrom('toma')]
    public ?\Nfse\Dto\Nfse\TomadorData $tomador = null;
    /**
     * Dados do intermediário do serviço.
     */
    #[MapFrom('interm')]
    public ?\Nfse\Dto\Nfse\IntermediarioData $intermediario = null;
    /**
     * Dados do serviço prestado.
     */
    #[MapFrom('serv')]
    public ?\Nfse\Dto\Nfse\ServicoData $servico = null;
    /**
     * Grupo de informações declaradas pelo emitente referentes ao IBS e à CBS.
     */
    #[MapFrom('IBSCBS')]
    public ?\Nfse\Dto\Nfse\IbscbsData $ibscbs = null;
    /**
     * Valores do serviço e tributos.
     */
    #[MapFrom('valores')]
    public ?\Nfse\Dto\Nfse\ValoresData $valores = null;
}
